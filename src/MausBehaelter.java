...
public class MausBehaelter implements IContainer, IComponente {
     ...
     * @param neueHoehe
     */
    public MausBehaelter(IContainer behaelter, int neuesX, int neuesY,
    ...
    public void setzeAlleMausereignisse() {
        obj.setMouseAction((1 << MausBehaelter.CLICK)
...
class CMausBehaelter extends BasisComponente implements IContainer,
